        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="space-y-6">
            {educationList.map((edu, index) => (
              ...
              >
                <div className="absolute -left-2.25 top-0 w-4 h-4 rounded-full bg-terminal-green border-2 border-background" />
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <GraduationCap className="w-5 h-5 text-accent-cyan mt-1 shrink-0" />
